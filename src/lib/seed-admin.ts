...
export const SEED_AUDIT_LOGS: AuditEntry[] = [
  {
    ...
    actor_name: 'Vaibhav Vishwakarma',
    actor_email: 'vaibhavvishwakarma0322@gmail.com',
    action: 'CREATE_CLUB',
    target_type: 'CLUB',
    target_name: 'CodeCraft Society',
    metadata: { branch_tags: ['Computer Science (CS)', 'Information Technology (IT)'], status: 'ACTIVE' },
